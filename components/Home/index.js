            ...
            <div className='runner-details-container'>
              <form className='form-controls' onSubmit={this.submitForm}>
                ...
                <div className='input-container'>
                  ...
                  <input type="text" id="timeInput" onChange={this.onChangeStartTime}/>
                </div>
            ...
            <div>
              {
                isgameRunnng ? (<div className='raceDisplay'>
                  ...
                  {/* {participants.map((each) => (
                  // <ul className='list-container'>
                  <ReactPopUp eachItem={each} key={each.id} onRestart = {this.onRestart}/>
                  // </ul>
                ))} */}
                  <ReactPopUp eachItem = {participants} onRestart = {this.onRestart}/>
